package com.anone.goods.controller;
...
public class SpuController {
     ...
     */
    @PutMapping("/pull/{id}")
    public Result pull(@PathVariable("id") Long supId) {
        spuService.pull(supId);
     ...
     */
    @PutMapping("/put/{id}")
    public Result put(@PathVariable("id")Long supId) {
        spuService.put(supId);
    ...
    public Result logicDel(@PathVariable("id")Long spuId) {
     ...
     */
    @GetMapping("/goods/{id}")
    public Result<Goods> findGoods(@PathVariable("id") Long supId) {
        Goods goods = spuService.findGoods(supId);
    ...
    public Result addGoods(@RequestBody Goods goods) {
        ...
        return new Result(true,StatusCode.OK,"新增或修改成功");
    }
