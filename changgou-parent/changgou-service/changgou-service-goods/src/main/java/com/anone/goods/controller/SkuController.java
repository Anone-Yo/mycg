...
import com.anone.goods.service.SkuService;
...
public class SkuController {
    ...
    public Result rollCount(Long skuId,Integer num) {
        skuService.rollCount(skuId,num);
    ...
    public Result decrMap(@RequestParam Map<String,Integer> decrMap) {
