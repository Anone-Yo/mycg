package com.anone.content.controller;
import com.anone.content.domain.Content;
import com.anone.content.service.ContentService;
...
public class ContentController {
    ...
    public Result<PageInfo> findPage(@RequestBody(required = false) @ApiParam(name = "Content对象",value = "传入JSON数据",required = false) Content content, @PathVariable("page")  int page, @PathVariable("size")  int size){
