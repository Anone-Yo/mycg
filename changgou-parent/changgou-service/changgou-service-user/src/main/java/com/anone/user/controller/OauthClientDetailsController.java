...
import com.anone.user.service.OauthClientDetailsService;
...
public class OauthClientDetailsController {
    ...
    public Result<PageInfo> findPage(@RequestBody(required = false) @ApiParam(name = "OauthClientDetails对象",value = "传入JSON数据",required = false) OauthClientDetails oauthClientDetails, @PathVariable("page")  int page, @PathVariable("size")   int size){
    ...
    @ApiImplicitParam(paramType = "path", name = "id", value = "主键ID", required = true, dataType = "String")
    @PutMapping(value="/{id}")
    public Result update(@RequestBody @ApiParam(name = "OauthClientDetails对象",value = "传入JSON数据",required = false) OauthClientDetails oauthClientDetails,@PathVariable("id")  String id){
        //设置主键值
