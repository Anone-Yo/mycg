...
import com.anone.user.service.AddressService;
...
public class AddressController {
    ...
    public Result<PageInfo> findPage(@RequestBody(required = false) @ApiParam(name = "Address对象",value = "传入JSON数据",required = false) Address address, @PathVariable("page")  int page, @PathVariable("size")   int size){
