...
public class SeckillGoodsController {
     ...
     */
    @RequestMapping("/one")
    public Result one(String dateMeun, Long id) {
        SeckillGoods seckillGoods = seckillGoodsService.one(dateMeun, id);
     ...
     * 获取时间菜单
     */
    @RequestMapping(value = "/datemenus")
    public Result getDateMeuns() {
        List<Date> dateMenus = DateUtil.getDateMenus();
        return new Result(true,StatusCode.OK,"查询时间菜单成功",dateMenus);
    }
     ...
     */
    @RequestMapping("/list")
    public Result<List<SeckillGoods>> list(String dateMeun) {
        List seckillGoodsList = seckillGoodsService.list(dateMeun);
