...
public class SeckillGoodsServiceImpl implements SeckillGoodsService {
     ...
     */
    @Override
    public SeckillGoods one(String dateMeun, Long id) {
     ...
     */
    @Override
    public List<SeckillGoods> list(String dateMeun) {
        String namespace="seckillGoods_"+dateMeun;
        List<SeckillGoods> seckillGoodsList = redisTemplate.boundHashOps(namespace).values();
