...
/*****
 * @Author: anone
 * @Description: com.anone.search.service.impl
 ****/
@Service
public class SkuServiceImpl implements SkuService {
     ...
     */
 @Override
    public Map<String, Object> searchData(Map<String, String> searchMap) throws Exception{
        /***
         * 搜索条件封装
         */
