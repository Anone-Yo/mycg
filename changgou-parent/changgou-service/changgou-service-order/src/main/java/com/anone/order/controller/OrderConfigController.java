...
import com.anone.order.domain.OrderConfig;
import com.anone.order.service.OrderConfigService;
...
public class OrderConfigController {
    ...
    public Result<PageInfo> findPage(@RequestBody(required = false) @ApiParam(name = "OrderConfig对象",value = "传入JSON数据",required = false) OrderConfig orderConfig, @PathVariable("page")  int page, @PathVariable("size")   int size){
    ...
    @ApiImplicitParam(paramType = "path", name = "id", value = "主键ID", required = true, dataType = "Integer")
    @PutMapping(value="/{id}")
    public Result update(@RequestBody @ApiParam(name = "OrderConfig对象",value = "传入JSON数据",required = false) OrderConfig orderConfig,@PathVariable("id")  Integer id){
        //设置主键值
