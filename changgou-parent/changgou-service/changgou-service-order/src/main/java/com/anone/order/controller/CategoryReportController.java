...
import com.anone.order.domain.CategoryReport;
import com.anone.order.service.CategoryReportService;
...
public class CategoryReportController {
    ...
    public Result<PageInfo> findPage(@RequestBody(required = false) @ApiParam(name = "CategoryReport对象",value = "传入JSON数据",required = false) CategoryReport categoryReport, @PathVariable("page")  int page, @PathVariable("size")   int size){
    ...
    @ApiImplicitParam(paramType = "path", name = "id", value = "主键ID", required = true, dataType = "Date")
    @PutMapping(value="/{id}")
    public Result update(@RequestBody @ApiParam(name = "CategoryReport对象",value = "传入JSON数据",required = false) CategoryReport categoryReport,@PathVariable("id")  Date id){
        //设置主键值
