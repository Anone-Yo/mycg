...
import com.anone.order.service.ReturnOrderService;
...
public class ReturnOrderController {
    ...
    public Result<PageInfo> findPage(@RequestBody(required = false) @ApiParam(name = "ReturnOrder对象",value = "传入JSON数据",required = false) ReturnOrder returnOrder, @PathVariable("page")  int page, @PathVariable("size")   int size){
    ...
    @ApiImplicitParam(paramType = "path", name = "id", value = "主键ID", required = true, dataType = "Long")
    @PutMapping(value="/{id}")
    public Result update(@RequestBody @ApiParam(name = "ReturnOrder对象",value = "传入JSON数据",required = false) ReturnOrder returnOrder,@PathVariable("id")  Long id){
        //设置主键值
