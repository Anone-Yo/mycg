...
import com.anone.order.service.OrderItemService;
...
public class OrderItemController {
    ...
    public Result<PageInfo> findPage(@RequestBody(required = false) @ApiParam(name = "OrderItem对象",value = "传入JSON数据",required = false) OrderItem orderItem, @PathVariable("page")  int page, @PathVariable("size")   int size){
    ...
    @ApiImplicitParam(paramType = "path", name = "id", value = "主键ID", required = true, dataType = "String")
    @PutMapping(value="/{id}")
    public Result update(@RequestBody @ApiParam(name = "OrderItem对象",value = "传入JSON数据",required = false) OrderItem orderItem,@PathVariable("id")  String id){
        //设置主键值
        orderItem.setId(id);
