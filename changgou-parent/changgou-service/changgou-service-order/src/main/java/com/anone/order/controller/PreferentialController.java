...
import com.anone.order.domain.Preferential;
import com.anone.order.service.PreferentialService;
...
public class PreferentialController {
    ...
    public Result<PageInfo> findPage(@RequestBody(required = false) @ApiParam(name = "Preferential对象",value = "传入JSON数据",required = false) Preferential preferential, @PathVariable("page")  int page, @PathVariable("size")   int size){
    ...
    @ApiImplicitParam(paramType = "path", name = "id", value = "主键ID", required = true, dataType = "Integer")
    @PutMapping(value="/{id}")
    public Result update(@RequestBody @ApiParam(name = "Preferential对象",value = "传入JSON数据",required = false) Preferential preferential,@PathVariable("id")  Integer id){
        //设置主键值
